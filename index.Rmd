...
This report documents the CSIEM technical specification, including the data integration with knowledge generation activities within the WAMSI Westport Research program. Improvements in the model functional capability, detailed validation tests, and assessment of the management and climate scenarios are reported here.
...
The CSIEM manual has been developed by the following project team:

ǂ Aquatic Ecodynamics, UWA Centre for Water and Spatial Sciences, The University of Western Australia, Crawley WA 6009, Australia.
*
...
The CSIEM documentation is available via GitHub and prepared in "R Mark Down" language. This is an implementation of mark down that can integrate with the R environment for enabling interactive content.
...
```{r logo1, echo=FALSE, out.width='15%', class = "text-image"}
