...
**Benthic algae observations:** There were areas on the shelf that had benthic algal communities in the sediment. This corresponded with Eyre *et al.*’s cores 7 and 8. According to Eyre’s lab core experiments, there was a net production of $O_2$ over the course of a day from photosynthesis (more $O_2$ production in the light than consumption in the dark) and hence a net efflux of $O_2$ into the water column. (This was not the usual assumption for fluxes in sediment models.)
