...
| \(k_{\text{e_ss1}}\) | m\(^2\) mg\(^{-1}\) | 0.085  | Fine suspended sediments: **0.01–0.03 m\(^2\) mg\(^{-1}\)**; higher for silts and clays with strong scattering properties. |
| \(k_{\text{ss2}}\) | m\(^2\) mg\(^{-1}\) |  0.045 | Coarser inorganic particles: **0.002–0.01 m\(^2\) mg\(^{-1}\)**; attenuation drops with increasing particle size. |
...
The bulk-PAR light model within AED was assessed using the WWMSP2-MS9 data-set (REF et al., 2024). The data-set sits at ~ 8 m on the Kwinana Shelf, and shows a range of conditions spanning through summer to 2022/2023 to winter of 2023. Figure 13.XX below shows six 2-3 week periods where conditions were assessed. 
...
**Figure 13.4-i.** Comparison of observed and simulated light ($PAR,\:W/m^2$), within the South Coast region. 
