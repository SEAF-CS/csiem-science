...
:::{.figcap}
**Figure 13.3-ii.** Comparison of observed and simulated light extinction coefficient ($K_d,\:  /m$), within Owen Anchorage.
:::
...
In application of the light model within Cockburn Sound we first undertake a controlled assessment of CSIEM by comparing and benchmarking against expected profiles across a gradient of conditions. For this purpose, locations in Table 13.1 were selected.


**Table 13.1.** Location of sites for model benchmarking, including seafloor depth (metres below mean sea level).
...
:::{.figcap}
**Figure 13.6-ii**. Absorption and scattering (/m) of optically active constituent species at $550\:nm$ for each site over the sunlit portion of the two days of the CSIEM simulation.
:::
...
:::{.figcap}
**Figure 13.6-iii**. Absorption and scattering (/m) of optically active constituent species at $700\:nm$ for each site over the sunlit portion of the two days of the CSIEM simulation.
:::
...
Figure 13.5 shows the surface illumination from NASA's Coupled Ocean and Atmosphere Radiative Transfer (COART) and from the developed light model in CSIEM for the 4 times identified in Figure 13.4. Whilst there can be noticeable differences in the direct/diffuse mix of light at the ocean surface, this plot shows a general agreement with an alternate well-regarded model. This supports the veracity of the locally-specific light model and its implementation in CSIEM.
...
:::{.figcap}
**Figure 13.13**. January 5, 2023 at 4pm (clear sky), spectral irradiances from EcoLight and CSIEM interpolated to 1m and 5m depths for the nine comparison sites.
:::
...
:::{.figcap}
**Figure 13.14**. January 6, 2023 at 4pm (cloudy conditions), spectral irradiances from EcoLight and CSIEM interpolated to 1m and 5m depths for the nine comparison sites.
:::
...
**Table 13.3**. Various input values for Hydrolight modelling
...
The orange curve on each plot is the spectral irradiance profile derived from Hydrolight for the Chl and TSS concentration values listed in Table 13.2, and for a CDOM value a440 = 0.02 m^-1^, clear sky and a sandy substrate.

The various thin blue curves show the spectral irradiance profiles derived from Hydrolight for the increasing CDOM values listed in Table 13.3 at either sandy or black substrate and clear or cloudy sky conditions.
...
:::{.figcap}
**Figure 13.16a.** Wavelength specific light profiles, showing best fit curves for light attenuation.
:::
