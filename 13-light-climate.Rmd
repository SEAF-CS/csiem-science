...
| \(k_{\text{phy}}\) | $m^{-1}/ (mmol\:C/m^{-3})^{-1}$ | 0.003 - 0.0051  | Phytoplankton chlorophyll-specific attenuation 0.015–0.03 m\(^2\) mg\(^{-1}\); ~0.02 m\(^2\) mg\(^{-1}\) commonly used in estuarine models. |
