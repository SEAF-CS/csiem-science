...
**Figure 13.4-iv.** Summary of observed light extinction coefficient ($K_d,\:  /m$) for PAR computed from the raw CS86 dual-light loggers, for a deployment in early Spring 2024. 

##### Summer  {.unnumbered}

![](./media/light/CS86_Deployment3_Kd_PAR_Violin_Swarm_Hourly.png){width=90%}

**Figure 13.4-v.** Summary of observed light extinction coefficient ($K_d,\:  /m$) for PAR computed from the raw CS86 dual-light loggers, for a deployment in late Summer 2024 
