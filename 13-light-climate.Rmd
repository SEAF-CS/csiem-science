...
![](./media/image73.png){width=95%}

**Figure 13.1.** Snapshots taken from Sentinel-2 imagery showing periods where different optical properties can dominate water properties in and around Cockburn Sound. Visit the [CSIEM Sentinel-2 explorer](https://csiemdash-leaflet.seaf.org.au) for details and further images.
...
![](./media/light/WQ_DIAG_TOT_EXTC/0014_CS_Region.png){width=90%}
...
![](./media/light/WQ_DIAG_TOT_EXTC/0023_OA_Region.png){width=90%}
...
![](./media/light/WQ_DIAG_TOT_EXTC/0036_GR_Region.png){width=90%}
...
![](./media/light/WQ_DIAG_TOT_EXTC/0059_SW_Region.png){width=90%}

**Figure 13.3-iv.** Comparison of observed and simulated light extinction coefficient ($K_d,\: /m$), within the South Coast region. 


### CS86 $K_d$ logger comparison

In addition to the profiling derived data (show above), the DWER mooring program includes a dedicated sensor array to compute $K_d$ directly. The CS86 site includes two light sensors vertically arranged in the water-column to have a fixed 1m of distance apart, allow a high-frequency data stream. The data was critically analysed and a sub-set of the data was screened and deemed to be useful for the model validation. This is shown in Figure 13.X for 5 of the deployments. 


#### {.panelset .unnumbered}

##### Early Spring Deployment  {.unnumbered}

![](./media/light/CS86_Deployment4_Kd_PAR_Violin_Swarm_Hourly.png){width=90%}

**Figure 13.4-i.** Summary of light extinction coefficient ($K_d,\:  /m$) for PAR computed from the raw CS86 dual-light loggers, for Spring 2023. 

##### Late Spring. Deployment  {.unnumbered}

![](./media/light/CS86_Deployment5_Kd_PAR_Violin_Swarm_Hourly.png){width=90%}

**Figure 13.4-i.** Summary of light extinction coefficient ($K_d,\:  /m$) for PAR computed from the raw CS86 dual-light loggers, for Spring 2023. 


##### Early Winter Deployment  {.unnumbered}

![](./media/light/CS86_Deployment2_Kd_PAR_Violin_Swarm_Hourly.png){width=90%}

**Figure 13.4-i.** Summary of light extinction coefficient ($K_d,\:  /m$) for PAR computed from the raw CS86 dual-light loggers, for Spring 2023. 

##### Early Spring Deployment  {.unnumbered}

![](./media/light/CS86_Deployment7_Kd_PAR_Violin_Swarm_Hourly.png){width=90%}

**Figure 13.4-i.** Summary of light extinction coefficient ($K_d,\:  /m$) for PAR computed from the raw CS86 dual-light loggers, for Spring 2023. 

##### Summer Deployment  {.unnumbered}

![](./media/light/CS86_Deployment3_Kd_PAR_Violin_Swarm_Hourly.png){width=90%}
