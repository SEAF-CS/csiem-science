...
The choice of simulation type depends on the research question being addressed, and users can choose to run either or both types of simulations as needed. Specifically:
 ...
 - **WQ** : designed to resolve nutrients, turbidity, chlorophyll-a and seagrass dynamics;
...
(ref:csiem-mesh) Plan-view of the three base CSIEM model meshes around the Cockburn Sound region, showing the **B** (optimised), **C** (fine) options, and **A** (coarse) mesh options.
...
(ref:csiem-integration) Overview of the CSIEM model integration ecosystem, depicting the links of the main hydrodynamic-water quality with other dependent model and data products that are required to run an integrated simulation. Down the list represents disciplinary integration and left to right represents spatio-temporal down-scaling.
