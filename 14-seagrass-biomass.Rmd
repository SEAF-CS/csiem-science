...
**Figure 7.4-i**. Substrate type and benthic habitat within the model domain based on WWMSP 2.1 mapping, including distribution of seagrass communities within the Cockburn Sound and Owen Anchorage (CSOA). Click to enlarge.

#### Temp/Sal Dataset Summary {.unnumbered}

![](./media/image123.png){width="6.301388888888889in" height="4.458333333333333in"}

**Figure 7.4-ii**. Substrate type and benthic habitat within the model domain based on WWMSP 2.1 and O2M mapping, including distribution of seagrass communities within the Cockburn Sound and Owen Anchorage (CSOA). Click to enlarge.
