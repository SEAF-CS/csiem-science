...
3. **Sediment modelling using CANDI-AED (see [Chapter 10](candi-aed))**
...
*The configuration of the model is configured via the `aed.nml` file, located in the `/includes/wq/` folder of the model repository. This records the specific combination of modules included (see Figure 11.3 bottom), and the final set of configured parameters.*
```
