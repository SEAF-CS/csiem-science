...
-	O2M-Westport CSOA EIA data product: an updated benthic map with additional benthic categories to WWMSP 2.1 mapping, including filter feeders and sparse/ephemeral seagrass. The classification of several dominant seagrass communities in this map differs to the WWMSP2.1 mapping (Figure 17.2)

The main sediment/substrate data-set is:

-	Skene et al. (2005) : interpolated sediment size data from within CS (Figure 17.3)
...
-	WC Bioregion survey : broadscale benthic habitat mapping product (Figure 17.4)

![](./media/image134.png){width="6.597234251968504in" height="4.664740813648294in"}

**Figure 17.1**. WWMSP Theme 2.1 CSOA benthic habitat map.

![](./media/image135.png){width="6.597234251968504in" height="4.664740813648294in"}

**Figure 17.2**. O2M-Westport CSOA EIA benthic habitat map.

![](./media/image136.png){width="6.597234251968504in" height="4.664740813648294in"}

**Figure 17.3**. Sediment size map within CS.

![](./media/image137.png){width="6.597234251968504in" height="4.664740813648294in"}

**Figure 17.4**. WCB bioregion benthic map.

## Benthic zone definition and layer descriptions 

The above raw data-sets require processing and merging before they are suitable for the CSIEM numerical model. Therefore, a synthesised product has been made for each fo the main CSOA benthic maps (Figure 17.5).
...
Depending on the mesh adopted, the layer information is translated to cell resolution accordingly, for example, as shown in Figure 17.7 for the three main types. 
...
**Figure 17.6-i**. CSIEM model domain and material zone settings based on WWMSP2.1 mapping. Left: whole model domain; Right: zoom-in view of Cockburn Sound.

#### WWMSP2.1-O2M-Westport merged {.unnumbered}

![](./media/image133.png){width="6.301388888888889in" height="4.458333333333333in"}

**Figure 17.6-ii**. CSIEM model domain and material zone settings based on merged WWMSP2.1-O2M mapping. Left: whole model domain; Right: zoom-in view of Cockburn Sound.



![](./media/model/image6.png){width="95%"}

**Figure 17.7.** Plan-view of CSIEM model benthic material types around the Cockburn Sound region in A (coarse), B (optimized), C (fine) options.
