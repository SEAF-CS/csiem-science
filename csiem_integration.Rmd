...
All of the ETL pipeline scripts for the CSIEM Environmental Information Management are all contained within the ```code/``` directory, which has three subfodlers:

  + `import`: All scripts that process the raw data from the data-lake into the data-warehouse
  + `actions`: GitHub action functions, and well as secondary functions to control with pipeline is executed automaticalls
