...
The CSIEM seeks to integrate a diverse range of data from various origins and providers. The types of data such as hydrologic, water quality, or ecological also creates a challenge to effectively organise in a robust, repeatable and transparanet way. The datasets are managed by different agencies and each use their own technical frameworks and standards for data organisation, so intgerating the diverse datasets requires development of a common set of metadata standards and reliable data processing workflows.
