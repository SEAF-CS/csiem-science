...
All data entering the sytem is recording in the CSIEM_Data_Catalogue.xlsx spreadsheet found the data-lake directory in the cseim-data github repository. The details of data catalogue are included in **Appendix A: Data Catalogue**.
