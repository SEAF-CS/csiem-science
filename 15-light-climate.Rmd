...
A range of high quality light-related data-sets have been collected for assessing the light, including long-term monitoring of light attenuation, above and below water sensors measureing *in situ* $PAR$, and several spectral (multi-wavelength) light sensor deployments. Refer to Figure 16.2 for a broad summary of past data collection efforts, and Table \@ref(tab:13-lightdata) for a summary of key data sets considered during model assessment. 
...
:::{.figcap}
**Figure 16.2.** Light data-set: Summary of CSIEM data catalogue showing identified hydrodynamics data. Click to enlarge. Visit the csiem-data catalogue for further information.
:::
...
The bulk-PAR light model within AED was assessed using the WWMSP2-MS9 data-set (Said et al., 2025). The data-set sits at a seabed depth of ~8 m on the western edge of Kwinana Shelf, and shows a range of conditions spanning from summer to 2022/2023 through to winter of 2023. Figure 16.XX below shows six 2-3 week periods where conditions were assessed. For this comparison the data was assumed to sit 20 cm above the seabed, and this was compared with the upper face of the bottom-most model layer.
...
:::{.figcap}
**Figure 16.4-i.** Comparison of observed and simulated light ($PAR,\:W/m^2$) on the Kwinana Shelf in December 2022. [REPLOT TO REMOVE SHADED REPLICATE]
:::
...
:::{.figcap}
**Figure 16.4-ii.** Comparison of observed and simulated light ($PAR,\:W/m^2$) on the Kwinana Shelf in January 2023. [REPLOT TO REMOVE SHADED REPLICATE]
:::
...
:::{.figcap}
**Figure 16.4-iii.** Comparison of observed and simulated light ($PAR,\:W/m^2$) on the Kwinana Shelf in February 2023. [REPLOT TO REMOVE SHADED REPLICATE]
:::
...
:::{.figcap}
**Figure 16.4-iv.** Comparison of observed and simulated light ($PAR,\:W/m^2$) on the Kwinana Shelf in March 2023.
:::
...
:::{.figcap}
**Figure 16.4-v.** Comparison of observed and simulated light ($PAR,\:W/m^2$) on the Kwinana Shelf in May 2023.
:::
...
:::{.figcap}
**Figure 16.4-vi.** Comparison of observed and simulated light ($PAR,\:W/m^2$) on the Kwinana Shelf in May 2023.
:::
...
Figure 16.X shows the shortwave radiation from CSIEM model data (upper panel) and from the weather observation data (lower panel) for the daylight hours of the two model simulation days. By choosing noon and 4pm on each day we have clear and cloudy conditions at the two solar zenith angles of approximately 10 and 50 degrees.

Summary plots are shown in Figure 16.2 that characterise these 9 locations in terms of extinction by optically active species and split into extinction due to absorption and to scattering. The results labelled 'TOTAL' represent the combined effect of all species. The aggregation is over the two days of the CSIEM simulation and are drawn from EcoLight computations for each profile at the half hour time-step of the CSIEM for the sunlit hours. The first figure is at 400nm, the second at 550nm and the third at 700nm.
...
:::{.figcap}
**Figure 16.4**. Shortwave flux from CSIEM model and from weather data. From 11:30 to 16:30 on 6 January, some amount of cloudiness diminishes the shortwave radiation compared to the clear sky conditions of the previous day, and cloudiness is greatest at noon and 4pm. These are the times we will use in comparing CSIEM model results with EcoLight to provide clear and cloudy conditions at two solar zenith angles.
:::

Figure 16.5 shows the surface illumination from NASA's Coupled Ocean and Atmosphere Radiative Transfer (COART) and from the developed light model in CSIEM for the 4 times identified in Figure 16.4. Whilst there can be noticeable differences in the direct/diffuse mix of light at the ocean surface, this plot shows a general agreement with an alternate well-regarded model. This supports the veracity of the locally-specific light model and its implementation in CSIEM.
...
:::{.figcap}
**Figure 16.5**. Surface illumination at the OASIM band centres from COART and CSIEM light models for the 4 comparison times in Fig B4. COART was run at 1nm resolution and aggregated to the OASIM bands.
:::
...
:::{.figcap}
**Figure 16.6**. $PAR$ at depth comparisons for sites Kwinana_Shelf, Mullaloo_Beach and Validation.
:::
...
:::{.figcap}
**Figure 16.7**. PAR at depth comparisons for sites East_Garden Island, Freshwater_Bay and Mangles_Bay.
:::
...
:::{.figcap}
**Figure 16.8**. PAR at depth comparisons for sites Deep_Basin and Owen_Anchorage.
:::
...
:::{.figcap}
**Figure 16.9**. PAR at depth comparisons for site West_Rottnest.
:::
...
:::{.figcap}
**Figure 16.11**. January 5, 2023 at noon (clear sky), spectral irradiances from EcoLight and CSIEM interpolated to 1m and 5m depths for the nine comparison sites.
:::
...
:::{.figcap}
**Figure 16.12**. January 6, 2023 at noon (cloudy conditions), spectral irradiances from EcoLight and CSIEM interpolated to 1m and 5m depths for the nine comparison sites.
:::
...
:::{.figcap}
**Figure 16.13**. January 5, 2023 at 4pm (clear sky), spectral irradiances from EcoLight and CSIEM interpolated to 1m and 5m depths for the nine comparison sites.
:::
...
:::{.figcap}
**Figure 16.14**. January 6, 2023 at 4pm (cloudy conditions), spectral irradiances from EcoLight and CSIEM interpolated to 1m and 5m depths for the nine comparison sites.
:::
...
:::{.figcap}
**Figure 16.15**. Surface illumination on January 5, 2023 (left panel) and how these data yield synthetic CSIEM and MS9 outputs (right panel). The source data are from EcoLight at $1\:nm$ resolution and the differences in the right panel are artefacts due only to the different processing paths.
:::
...
:::{.figcap}
**Figure 16.16a.** Wavelength specific light profiles, showing best fit curves for light attenuation.
:::
...
:::{.figcap}
**Figure 16.16b.** Wavelength specific light profiles, showing best fit curves for light attenuation.
:::
...
:::{.figcap}
**Figure 16.16c.** Wavelength specific light profiles, showing best fit curves for light attenuation.
:::
...
:::{.figcap}
**Figure 16.16d.** Wavelength specific light profiles, showing best fit curves for light attenuation.
:::

## Spectral validation

Figure 16.17 shows a comparison of the CSIEM spectral measurement vs the value observed via the is situ measurement sensor at the Kwinana Shelf site. The field data from this sensor had some questionable signatures, including peak irradiance at 470nm, so this was not further explored.
...
:::{.figcap}
**Figure 16.20.** Wavelength specific light profiles, showing best fit curves for light attenuation.
:::
